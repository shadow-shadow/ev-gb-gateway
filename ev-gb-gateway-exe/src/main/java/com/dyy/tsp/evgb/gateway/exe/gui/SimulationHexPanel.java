...
public class SimulationHexPanel extends JPanel {
    ...
    public SimulationHexPanel(BusinessHandler businessHandler) {
        super();
        businessHandler.setSimulationHexPanel(this);
        ...
        int height = 230;
        inputArea = ComponentUtil.createJTextArea("请输入JSON报文...",FontConfig.font16,Boolean.TRUE);
        ...
        this.add(inputJsp);
        /*******************解析和清空按钮************************/
        decodeBtn = ComponentUtil.createJButton("编码",Config.mainPanelWidth-110,10,80,35,FontConfig.font16);
        this.add(decodeBtn);
...
//        jsp2.setRowHeaderView(new LineNumberHeaderView(FontConfig.font16));
        ...
        decodeBtn.setActionCommand("JSON-DECODE");
        clearBtn.addActionListener(acctionEvent);
        clearBtn.setActionCommand("JSON-CLEAR");
    }
